...
EXAMPLE_DIRECTORIES = ['tutorial', 'error-model', 'ipv6', 'energy', 'udp-client-server', 'wireless', 'naming', 'matrix-topology', 'tcp', 'stats', 'realtime', 'udp', 'socket', 'routing']
...
NS3_EXECUTABLE_PATH = ['/home/shruthi/vns/ns-3-dev/build/src/fd-net-device', '/home/shruthi/vns/ns-3-dev/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.9', '/home/shruthi/vns/ns-3-dev/build']
...
cfg_files = ['/home/shruthi/vns/ns-3-dev/build/ns3/config-store-config.h', '/home/shruthi/vns/ns-3-dev/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
